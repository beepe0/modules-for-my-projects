...
namespace Network.UnityTools
{
    public abstract class UNetworkPacket
    {
        ...
        public string ReadString(bool movePointer = true)
        {
            ...
            if (movePointer) ReadPointer += length;
            return res;
        }
